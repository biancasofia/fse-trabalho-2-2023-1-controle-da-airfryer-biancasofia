...
Aluna: Bianca Sofia Brasil


https://youtu.be/6ocReVe5qLM

## Instalação

1. Clonar o repositório dentro da placa;
2. Instalar as dependências do projeto: `pip install -r requirements.txt`.
3. Caso um módulo não esteja na placa, basta rodar o `pip install` seguido do módulo.
4. Entrar na pasta src.
5. Executar  `python3 main.py` para iniciar.


## Vídeo:
Link para o vídeo do funcionamento: https://youtu.be/6ocReVe5qLM

## Gráficos

### Gráfico gerado no Dashboard

<div style="text-align:center">
    <img src="/figuras/grafico.jpeg" alt="Gráfico">
</div>
 
### CSVs

<div style="text-align:center">
    <img src="/figuras/csv2.jpeg" alt="csv gerado">
</div>

<div style="text-align:center">
    <img src="/figuras/csv1.jpeg" alt="csv gerado">
</div>
